...
class Gradeset(ComplexChoices):
    ...
    class GCSE_9(models.TextChoices):
        ...
        DOUBLE_51 = 'gcse-55-11','5-5 5-4 4-4 4-3 3-3 3-2 2-2 2-1 1-1 U'
        DOUBLE_93 = 'gcse-99-33','9-9 9-8 8-8 8-7 7-7 7-6 6-6 6-5 5-5 5-4 4-4 4-3 3-3 U'
        DOUBLE_943 = 'gcse-99-43','9-9 9-8 8-8 8-7 7-7 7-6 6-6 6-5 5-5 5-4 4-4 4-3 U'
        DOUBLE_PAIRED_91 = 'gcse-9p-1p', '9-9 8-8 7-7 6-6 5-5 4-4 3-3 2-2 1-1 U'
        DOUBLE_PAIRED_51 = 'gcse-5p-1p', '5-5 4-4 3-3 2-2 1-1 U'
        DOUBLE_PAIRED_41 = 'gcse-4p-1p', '4-4 3-3 2-2 1-1 U'
        DOUBLE_PAIRED_93 = 'gcse-9p-3p', '9-9 8-8 7-7 6-6 5-5 4-4 3-3 U'
        DOUBLE_PAIRED_94 = 'gcse-9p-4p', '9-9 8-8 7-7 6-6 5-5 4-4 U'
    class GCSE_A(models.TextChoices):
        ...
        DOUBLE_PAIRED_ASG = 'gcse-A*A*-GG', 'A*-A* A-A B-B C-C D-D E-E F-F G-G U'
        DOUBLE_PAIRED_AG = 'gcse-AA-GG', 'A-A B-B C-C D-D E-E F-F G-G U'
        DOUBLE_PAIRED_CG = 'gcse-CC-GG', 'C-C D-D E-E F-F G-G (U)'
        DOUBLE_PAIRED_EXT = 'gcse-A*A*-EE', 'A*-A* A-A B-B C-C D-D E-E (U)'
    class IB(models.TextChoices):
        PASS_FAIL = 'ib-bin', 'Pass Fail'
        SINGLE_71 = 'ib-7-1', '7 6 5 4 3 2 1'
        SINGLE_71N = 'ib-7-1N', 'n/a 7 6 5 4 3 2 1'
    ...
    class AGQ(models.TextChoices):
        ...
        DOUBLE_DSP = 'agq.D*D*-PP', 'D*D* D*D DD DM MM MP PP (U)'
        TRIPLE_DSP = 'agq.D*D*D*-PPP', 'D*D*D* D*D*D D*DD DDD DDM DMM MMM MMP MPP PPP U'
